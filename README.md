[![Typing SVG](https://readme-typing-svg.demolab.com?font=Fira+Code&pause=900&color=00F5D4&width=600&lines=Hi%2C+I'm+Sajeed.;Full-Stack+Developer+%7C+AI+Development;Yes%2C+this+is+a+README.;Fine%2C+scroll+down...)](https://notsajeed.github.io)

[notsajeed.pages.dev](https://notsajeed.pages.dev)
...
[![LEFT](https://img.shields.io/badge/LEFT-brightgreen?style=for-the-badge)](https://snake-api-6tjn.onrender.com/move/left?redirect=https://github.com/notsajeed)
[![UP](https://img.shields.io/badge/UP-brightgreen?style=for-the-badge)](https://snake-api-6tjn.onrender.com/move/up?redirect=https://github.com/notsajeed)
...
| Project | Description |
| --- | --- |
| [LeetCity](https://notsajeed.pages.dev/projects/leetcity.html) | Interactive 3D skyline visualization platform for LeetCode activity. |
| [PD](https://notsajeed.pages.dev/projects/parkinsons.html) | Multimodal gait and voice analysis with explainable deep learning for clinically realistic PD screening. |
| [MCBots](https://notsajeed.pages.dev/projects/mcbots.html) | Experimental multi-bot orchestration system for Minecraft LAN worlds. |
| [VizQ](https://notsajeed.pages.dev/projects/vizq.html) | Structured visualization and information exploration system. |
| [TPG](https://notsajeed.pages.dev/projects/tpg.html) | Title page generator for MSRIT students. |
| [Py4096](https://notsajeed.pages.dev/projects/py4096.html) | 4096 puzzle game in terminal. |
| [3body](https://notsajeed.pages.dev/projects/3body.html) | Real-time numerical simulation of chaotic orbital mechanics. |
...
[![GitHub](https://img.shields.io/badge/GitHub-181717?style=flat&logo=github&logoColor=white)](https://youtu.be/xvFZjo5PgG0?si=OGERPSsEoeza5zLY)
